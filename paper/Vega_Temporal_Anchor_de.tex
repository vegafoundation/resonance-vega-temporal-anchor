...
\title{Vega Temporal Anchor: Ein konzeptioneller Rahmen}
...
\begin{abstract}
Diese Arbeit führt Vega Temporal Anchor als neues konzeptionelles Rahmenwerk innerhalb des Resonance Data und QIRC Paradigmas ein. Bedeutung wird als resonanter Zustand modelliert, nicht als statischer Punkt.
...
Vega Temporal Anchor represents a novel contribution to the field of meaning-first computing
and resonance-based information processing.

\section{Definition}
Vega Temporal Anchor is defined as a conceptual framework that...
...
Vega Temporal Anchor extends the Resonance Data paradigm by...
...
\section{Conclusion}
Vega Temporal Anchor provides a new lens for understanding meaning
